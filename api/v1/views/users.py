#!/usr/bin/python3
'''
    RESTful API a function used to  actions for user object
'''
...
def get_all_users():
    '''
       a function used to Retrieve all user objects
    '''
    user_list = []
...
def get_user(user_id):
    '''
       a function used to Retrieve one user object
    '''
    try:
...
def delete_user(user_id):
    '''
       a function used to Delete a User object
    '''
    try:
...
def post_user():
    '''
       a function used to Create a user object
    '''
    if not request.json:
...
def put_user(user_id=None):
    '''
       a function used to Update a user object
    '''
