#!/usr/bin/python3
'''
    RESTful API function for actions for user object
'''
...
def get_review(review_id):
    '''
        a function that Retrieve one review object
    '''
    try:
...
def post_review():
    '''
        a function that creates a review object
    '''
    if not request.json:
...
def put_review(review_id):
    '''
        a function that Updates a new review object
    '''
